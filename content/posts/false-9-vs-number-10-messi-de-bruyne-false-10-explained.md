...
A **Number 10** starts as an attacking midfielder and creates chances between the lines.  
A **False 10** starts like a Number 10, but moves away from that fixed zone to manipulate space.
...
If a centre-back follows, space opens behind.  
If the defender stays, the False 9 has time to turn and create.
...
The key is not his shirt number.  
The key is how his movement changes the defensive picture.

When De Bruyne moves wide, a midfielder has to decide whether to follow.  
When he drops deeper, the defensive line has to decide whether to step out.  
When he arrives late, defenders often lose track of him.
